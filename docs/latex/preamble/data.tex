...
\newcommand*{\ThesisTitle}{Acoustic OFDM System}
...
\newcommand*{\Department}{\textcolor{red}{Wireless receivers: algorithms and architectures}}

%% Is it a Department (katedra), or an Institute (ústav)?
\newcommand*{\DeptType}{Institute}

%% Thesis supervisor: name, surname and titles
\newcommand*{\Supervisor}{\textcolor{red}{TCL – Telecommunications Circuits Laboratory epfl}}
...
\newcommand*{\StudyProgramme}{\textcolor{red}{Electrical and Electronic Engineering}}
